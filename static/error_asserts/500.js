...
const messages = [
    ...
    ['Sorry. Can You Refrech the page.', 'Apologies, Can You Refrech the page.', 'Our bad, Can You Refrech the page.', 'Sad day, Can You Refrech the page.', 'We are quite contrite, Can You Refrech the page.', 'Beg pardon, Can You Refrech the page.']
  ];
